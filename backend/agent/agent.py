...
SYSTEM_PROMPT = (
    ...
    "IMPORTANT: When the user has dietary restrictions or allergies "
    "(e.g. 不吃辣/香菜/猪肉/海鲜过敏/素食), recommended dishes MUST NEVER include "
    "any dish matching those restrictions. "
